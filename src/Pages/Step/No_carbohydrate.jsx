    ...
    return (
        <Box sx={{width:'50%',top:'20%', left:'35%', position:'absolute'}}>
            ...
            <Button
                ...
                endIcon={
                    <Box sx={{ order: 1 }}>
                        {isBread ? <CheckIcon sx={{ color: 'green' }} />:""}
                    </Box>
                }
                onClick={() => setIsBread(!isBread)}
            >
                <Box sx={{ order: 0 }}>
                    Bread
                </Box>
            ...
            <Button
                ...
                endIcon={
                    <Box sx={{ order: 1 }}>
                        {isPasta ? <CheckIcon sx={{ color: 'green' }} />:""}
                    </Box>
                }
                onClick={() => setIsPasta(!isPasta)}
            >
                <Box sx={{ order: 0 }}>
                    Pasta
                </Box>
...
export default connect(null, {addAnswer})(No_carbohydrate)