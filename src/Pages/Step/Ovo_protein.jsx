    ...
    return (
        <Box sx={{width:'50%',top:'20%', left:'35%', position:'absolute'}}>
            ...
            <Button
                ...
                endIcon={
                    <Box sx={{ order: 1 }}>
                        {isMilk ? <CheckIcon sx={{ color: 'green' }} />:""}
                    </Box>
                }
                onClick={() => setIsMilk(!isMilk)}
            >
                <Box sx={{ order: 0 }}>
                    Milk
                </Box>
            ...
            <Button
                ...
                endIcon={
                    <Box sx={{ order: 1 }}>
                        {isCheese ? <CheckIcon sx={{ color: 'green' }} />:""}
                    </Box>
                }
                onClick={() => setIsCheese(!isCheese)}
            >
                <Box sx={{ order: 0 }}>
                    Cheese
                </Box>
...
export default connect(null, {addAnswer})(Ovo_protein)