...
const Step11 = (props) => {
    ...
    const handleNext = (answer) => {
        props.addAnswer(12, 'intolerance', answer);

        navigate('/step12', {replace: true})
    }
    ...
    return (
        <Box sx={{display:'flex'}}>
            <Box sx={{width:'30%',top:'20%', left:'35%', position:'absolute'}}>
                <Typography variant='h3' sx={{marginBottom:'10px'}}>Intolerance</Typography>
                <p>Do you have any type of intolerance?</p>
                <Button
                    variant="outlined"
                    sx={{ 
                        width:'100%',
...
export default connect(null, {addAnswer})(Step11)